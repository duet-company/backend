...
class TestDataSourceModel:
    """Test suite for DataSource model (unit tests - no database operations)."""
...
class TestDataSourceModelIntegration:
    """Integration tests for DataSource model (requires database)."""
